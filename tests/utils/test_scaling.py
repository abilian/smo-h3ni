from utils.scaling import decide_replicas
...
def test_decide_replicas_feasible():
    ...
    solution = decide_replicas(
        request_rates, previous_replicas, cpu_limits, acceleration,
        alpha, beta, cluster_capacity, cluster_acceleration, maximum_replicas
    )
