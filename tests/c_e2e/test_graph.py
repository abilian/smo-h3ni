...
TEST_GRAPH = json.dumps({
    "hdaGraph": {
        ...
        "hdaGraphIntent": {
            ...
            "energyEfficiency": {"enabled": False},
        },
        ...
        "services": [
            {
                            ...
                            "events": [
                                {
                                    "id": "main-event",
                                    "source": [
                                        {"serviceId": "vo", "metricId": "vo-metric"}
                                    ],
                                    "condition": {
                ...
                "artifact": {
                    ...
                    "ociConfig": {"type": "VO", "implementer": "WOT"},
...
def test_graph_lifecycle(client):
    ...
    with (
        patch("services.hdag.graph_service.helm_install_artifact") as mock_install,
