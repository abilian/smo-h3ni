...
# This Vagrantfile is designed to work with both x86_64 and arm64 hosts (and guests)
# It may be suboptimal for your specific use case, so feel free to modify it.
