...
from utils.grafana_template import create_basic_dashboard, create_dashboard_variables,\
    create_panels_cluster, create_panels_service
...
class GrafanaHelper:
    ...
    def create_graph_dashboard(self, graph_name, service_names):
        ...
        dashboard['dashboard']['panels'] = create_panels_service(f'${templated_service_name}')
        dashboard['dashboard']['templating'] = create_dashboard_variables(templated_service_name, service_names)
        return dashboard
